 ...
 * });
 */
export function addTag(tag: any, options?: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addHeaderParameter(header: any, options?: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addBodyParameter(body: any, options?: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addQueryParameter(query: any, options?: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addFormDataParameter(formData: any, options?: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addPathParameter(path: any, options?: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addResponse(response: any, options?: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addResponseHeader(responseHeader: any, options: any) {
  addToCommon(
    {
 ...
 * });
 */
export function addModel(model: any, inputOptions?: any) {
  const options = {
  ...
  Object.keys(definitions).forEach(function (key) {
    const definition = _.cloneDeep(definitions[key]);
    definition.name = key;
    addModel(definition, inputOptions);
  });
}
function addToCommon(options: any, inputOptions?: any) {
  applyDefaults(options, inputOptions);
  ensureObjectExists(options);
  cloneObject(options);
...
function applyDefaults(options: any, inputOptions?: any) {
  if (!options) {
...
function ensureObjectExists(options: any) {
...
function cloneObject(options: any) {
...
function getKey(object: { name: any; modelName: any }) {
  let key = object.name;
  if (object.modelName) {
